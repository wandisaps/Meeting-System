...
if (file_exists(DOMPDF_DIR . "/dompdf_config.custom.inc.php") ) {
    include_once DOMPDF_DIR . "/dompdf_config.custom.inc.php";
}
...
if (DOMPDF_ENABLE_AUTOLOAD) {
    include_once DOMPDF_INC_DIR . "/autoload.inc.php";
    include_once DOMPDF_LIB_DIR . "/php-font-lib/classes/Font.php";
}
