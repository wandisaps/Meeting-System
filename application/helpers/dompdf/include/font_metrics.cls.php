...
class Font_Metrics
{
    ...
    {
        $dist_fonts = include_once DOMPDF_DIR . "/lib/fonts/dompdf_font_family_cache.dist.php";
        ...
        if (is_readable(DOMPDF_FONT_DIR . "dompdf_font_family_cache") ) {
            $old_fonts = include_once DOMPDF_FONT_DIR . "dompdf_font_family_cache";
        ...
        self::$_font_lookup = include_once self::CACHE_FILE;
