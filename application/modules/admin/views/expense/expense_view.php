...
<section class="content">
    ...
    <section class="content invoice">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                <b><?php echo lang('bill_number')?> #<?php echo $details->bill_number ?></b><br/>
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center" >
                <label for="name" ><?php echo lang('bill_date');?> : </label><br/>
                <div><?php echo ($details->bill_date) ? date('d M, Y', strtotime($details->bill_date)) : "-"; ?></div>
            </div>
            ...
            <div class="box-body table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php if(isset($details) && isset($expense_product) && !empty($expense_product)) { ?>
                        <tbody>
            ...
            <div class="col-md-6 mb-15">
                <label for="name margin-left-44"><?php echo (isset($sum_price) && $sum_price ? $sum_price : 0);?>  </label>

                <label for="name" class="margin-left-145"><?php echo (isset($sum_tax) && $sum_tax ? $sum_tax : 0);?></label>
            </div>
            <hr class="w-100">
            <div class="col-md-8"></div>
            <div class="col-md-4 mb-15 ">
                <label for="name" class="width-170"><?php echo lang('sub_total');?></label>
                <label for="name" ><?php echo (isset($sum_amount) && $sum_amount ? $sum_amount :0);?>  </label>
            </div>
            <hr class="w-100">
            <div class="col-md-8"></div>
            <div class="col-md-4 mb-15">
                <label for="name" class="width-170" ><?php ; echo lang('tax');?><?php echo (isset($details->tax_name) && $details->tax_name ? '( '.$details->tax_name.' )' : "");?></label>
                <label for="name" ><?php echo (isset($sum_tax) && $sum_tax ? $sum_tax : 0);?>  </label>
            </div>
            <hr class="w-100">
            <div class="col-md-8"></div>
            <div class="col-md-4 mb-15" >
                ...
                <?php
                    $sum_tax = (isset($sum_tax) && $sum_tax ? $sum_tax :0);
                    $sum_amount = (isset($sum_amount) && $sum_amount ? $sum_amount : 0);
        ...
        <div class="row no-print">
            ...
            <?php if(check_user_role(109)==1) {?>
                  <a href="<?php echo site_url('admin/invoice/mail/'.$details->id)?>"class="btn btn-primary pull-right mr-5"><i class="fa fa-mail-forward"></i> <?php echo lang('mail_to_client') ?></a>
            <?php } ?>
            </div>
        </div>
        <?php } ?>    
