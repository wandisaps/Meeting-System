                            ...
                            <?php $i=1;foreach ($documents as $new){
                                ...
                                <tr class="gc_row">
                                    ...
                                    <td><?php echo $new->title?></td>
                                     <td class="col-md-3">
                                        <div class="btn-group">
                                         <!-- <a class="btn btn-default ml-2" download  href="<?php echo base_url('uploads/documents/'.$new->file_name); ?>" ><i class="fa fa-download"></i> <?php echo lang('download');?></a> -->
                                         
                                <?php if(check_user_role(153)==1) {?>     
                                         <a class="btn btn-danger ml-2"  href="<?php echo site_url('admin/documents/delete_case_document/'.$new->id); ?>" onclick="return areyousure()"><i class="fa fa-trash"></i> <?php echo lang('delete');?></a>
                                <?php } ?>
                                         </div>
                                    </td>
                                </tr>
