...
class User_role_model extends CI_Model
{
    ...
    function get_user_role_name($name)
    {
        return $this->db->select('name')->like('name', $name)->count_all_results('user_role');
    }
    ...
    function get_all()
    {
        $this->db->where('id !=',1)->where('id !=',2);
        return $this->db->order_by('id','asc')->get('user_role')->result();
    }
