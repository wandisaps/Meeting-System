 ...
 */
class Translator extends MX_Controller
{
    ...
    {
        if($id) {
            $this->data['language']    =    $language    =    $this->language_model->get_language_id($id); 
            $this->slaveLang    =    strtolower($language->name);
        }
        $this->langModule    =    'admin_lang.php';
        ...
        if ($this->_configured() ) {
            ...
            if(!empty($_POST['SaveLang'])) {
                if ($this->_translation_saved($result) ) {
                    ...
                    $this->session->set_flashdata('message', lang('language_file_updated'));
                    redirect('admin/languages');
                } else {
                    $this->session->set_flashdata('error', lang('language_failed'));
                    redirect('admin/languages');
                }
            }
            $this->data['slaveLang']    =    $this->slaveLang;
        ...
        $this->data['body'] = 'language/translateLang';
    ...
    function _load_post_data()
    {
        ...
        ///echo '<Pre>'; print_r($this->translations);die;    
